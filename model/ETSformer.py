...
from layers.ETSmodules import ETSEmbedding
from layers.ETS_EncDec import EncoderLayer, Encoder
from layers.ETS_EncDec import DecoderLayer, Decoder
...
class ETSformer(nn.Module):
    ...
    def __init__(self, configs):
        ...
        # Embedding
        self.enc_embedding = ETSEmbedding(configs.d_feature, configs.d_model, dropout=configs.dropout)
