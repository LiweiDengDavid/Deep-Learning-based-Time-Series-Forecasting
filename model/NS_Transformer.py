...
class NS_Transformer(nn.Module):
    ...
    def __init__(self, configs):
        ...
        self.tau_learner = Projector(enc_in=configs.d_feature, seq_len=configs.seq_len, hidden_dims=configs.p_hidden_dims,
                                     hidden_layers=configs.p_hidden_layers, output_dim=1)
        self.delta_learner = Projector(enc_in=configs.d_feature, seq_len=configs.seq_len,
